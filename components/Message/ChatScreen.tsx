...
import { getMessages, sendMessageToRece } from '../../api/User/Get/user';
import { currentUser } from '../../redux/user/userAuthSlicer';

function ChatScreen({ chat }: any) {
    ...
    async function sendMessageToReceiver(){
        await sendMessageToRece(userId,chatId,sendMessage)
    }
        ...
        <div className="flex flex-col flex-auto h-full md:p-6">
            <div className=" relative flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-gray-100 md:mt-4 min-h-[82vh]  max-h-[82vh] ">
                ...
                <div className="flex flex-row absolute items-center h-16 rounded-xl bg-white w-full px-4 bottom-0 border shadow-lg">
                    ...
                    <div className="ml-4">
                        <button onClick={sendMessageToReceiver} className="flex items-center justify-center bg-indigo-500 hover:bg-indigo-600 rounded-xl text-white px-4 py-1 flex-shrink-0">
                            <span>Send</span>
                            <span className="ml-2">
                                <svg
