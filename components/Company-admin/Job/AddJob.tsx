                        ...
                        <div className="text-center flex justify-between">
                            ...
                            </h6>
                            {
                                save ? (
                                    ...
                                    <button className="bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button" onClick={handleSubmit}>
                                        Post
                                    </button>
                                )
                            }
                            ...
                            <div className="flex flex-wrap">
                                <div className="w-full lg:w-12/12 px-4">
                                    <div className="relative w-full mb-3">
                                        ...
                                        <input name='job' onKeyDown={preventFormFromEnter} onChange={handleEdit} type="text" placeholder='Job title/position name' className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" />
                                    </div>
                                </div>
                                <div className="w-full lg:w-12/12 px-4">
                                    <div className="relative w-full mb-3">
                                        ...
                                        <textarea name="jobDescription" onKeyDown={preventFormFromEnter} onChange={handleEdit} placeholder='Put some job details here' className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" />
                                    </div>
                                </div>
                                <div className="w-full lg:w-12/12 px-4">
                                    <div className="relative w-full mb-3">
                                        ...
                                        <textarea name="jobQualification" onKeyDown={preventFormFromEnter} onChange={handleEdit} placeholder='Put something that essential requirements of the job position with
                            ...
                            <div className="flex flex-wrap">
                                <div className="w-full lg:w-12/12 px-4">
                                    <div className="relative w-full mb-3">
                                        ...
                                        <textarea name="aboutCompany" onKeyDown={preventFormFromEnter} onChange={handleEdit} placeholder='Detailing your company history, core values, principles and/or
                            ...
                            <div className="flex flex-wrap">
                                <div className="w-full lg:w-12/12 px-4">
                                    <div className="relative w-full mb-3">
                                        ...
                                        <textarea name="benefits" onKeyDown={preventFormFromEnter} onChange={handleEdit} placeholder='Put something that applicants will find most
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        <textarea name="applications" onKeyDown={preventFormFromEnter} onChange={handleEdit} placeholder='Put something that applicants will find most
                                        enticing about the job position.' className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" />
                                    </div>
                                </div>
                            </div>
