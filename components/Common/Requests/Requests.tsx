            ...
            <li className="border-l-2 border-purple-600">
                <div className="md:flex flex-start ">
                    <div className="block p-6 rounded-lg shadow-lg bg-gray-100 w-full mx-6 my-6">
                        ...
                        {type == 'companyAdmin' && !request.adminApproved && <p className="text-red-500 mb-6">Company rejected your request for <span className='text-gray-800 italic text-sm font-semibold'>{request.message}</span></p>}
                        {
