        ...
        <PublicRoute>
            <ThemeProvider theme={theme}>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    sx={{
                                        mt: 3,
                                        mb: 2,
                                        backgroundColor: "#59779b",
                                        height: 50,
                                        "&:hover": { backgroundColor: "#59779b" },
                                    }}
                                    style={{ backgroundColor: "#59779b" }}
                                >
                                    {isLoading ? (
                            ...
                            <div className="flex justify-center flex-col mt-3">
                                <p className="text-center">Does not have an account? <span onClick={SignUpPage} className="cursor-pointer hover:text-[#59779b]">Sign Up</span> </p>
                                <p className="text-center">or </p>
                                <p className="text-center">Want to Login to your page? <span onClick={createCompany} className="cursor-pointer hover:text-[#59779b]">Go to Page</span> </p>
                            </div>
                        </Box>
                    </Container>
                    <Box
                    ...
                    >
                        <Image
                            src="https://img.freepik.com/premium-vector/secure-login-sign-up-concept-illustration-user-use-secure-login-password-protection-website-social-media-account-vector-flat-style_7737-2273.jpg?w=2000"
                            alt=""
                            width={520}
                            height={520}
                        />
